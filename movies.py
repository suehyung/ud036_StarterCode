...
# These are instances of class media.Movie, populated with strings for title, storyline, poster_image, and trailer_youtube
...
movies = [the_rock, back_future, bladerunner, empire, dazed_confused, groundhog]
# Calls the function that creates and opens in a new tab an HTML file using the list of movie objects above
